...
class Dialplans extends MY_Controller {
    ...
    public function addD() {
        ...
        //SAM: esta linea no mostraba ningun resultado: "ASC LIMIT 10000, 0" 
        //$response = $this->carrier_mod->get_data('', 0, 10000, array('carrier_status' => 1), array());
        //function get_data($order_by = '', $limit_to = '', $limit_from = '',.....
        $response = $this->carrier_mod->get_data('', 10000, 0, array('carrier_status' => 1), array());
        //print_r($response);
        $data['route_data'] = $route_data['result'];
    ...
    public function editD() {
        ...
        if (!empty($dialplan_id) && strlen($dialplan_id) > 0) {
            ...
            if ($response_data['total'] > 0) {
                ...
                $data['route_data'] = $route_data['result'];
                //SAM: esta linea no mostraba ningun resultado: orden de los limites superior e inferior 
                //$carrier_data = $this->carrier_mod->get_data('', 0, 100, array('carrier_status' => 1), array());
                $carrier_data = $this->carrier_mod->get_data('', 100, 0, array('carrier_status' => 1), array());
                $data['carrier_data'] = $carrier_data['result'];
